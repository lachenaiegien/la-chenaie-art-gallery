        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Un écrin historique exceptionnel à Gien, dans le Loiret, où l'art contemporain 
              dialogue avec l'architecture classique française dans un cadre naturel préservé.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="animate-gallery-scale-in">
              <div className="relative rounded-2xl overflow-hidden shadow-gallery-strong">
                <img
                  src={chateauImage}
            ...
            <div className="space-y-8 animate-gallery-fade-in">
              <Card className="p-8 bg-card border-border shadow-gallery-soft">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Le Château de La Chénaie, édifice du XVIIe siècle, offre un cadre unique pour 
                  l'art contemporain. Ses jardins à la française et son parc paysager constituent 
                  un dialogue permanent entre patrimoine historique et création moderne.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Restauré avec soin, le domaine accueille désormais des expositions d'art 
                  contemporain de renommée internationale, créant un pont entre les époques 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="p-6 bg-card border-border shadow-gallery-soft">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Gare de Gien (ligne Paris-Nevers), 
                    puis taxi ou location vélo.
                  </p>
                </Card>
              </div>
