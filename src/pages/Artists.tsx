  ...
  const artists: Artist[] = [
    {
      ...
      country: "Chine",
      birthYear: 1975,
      speciality: ["Sculpture contemporaine", "Acier inoxydable", "Art monumental"],
      exhibitions: [
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Découvrez les artistes contemporains qui exposent leurs œuvres au Domaine La Chénaie. 
                Chaque artiste apporte sa vision unique et son savoir-faire exceptionnel.
              </p>
            </div>
                    ...
                    <div className="md:col-span-1">
                      <div className="aspect-[3/4] bg-muted rounded-lg flex items-center justify-center">
                        <div className="text-center text-muted-foreground">
                          <div className="w-16 h-16 bg-gallery-gold rounded-full mx-auto mb-4 flex items-center justify-center">
            ...
            <div className="text-center mt-16 p-8 bg-muted rounded-lg">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Le Domaine La Chénaie accueille régulièrement de nouvelles expositions. 
                Contactez-nous pour présenter votre travail dans notre cadre exceptionnel.
              </p>
              <Button asChild>
                <a href="mailto:contact@lachenaiecalmeetdetente.com">
