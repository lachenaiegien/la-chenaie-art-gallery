  ...
  const artworks: Artwork[] = [
    {
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1H9PC4q04ifFLXrX4HiOsAqen4dOJStdY/view?usp=sharing' // À remplacer par le lien Drive
    },
    {
      id: '2',
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1OXFJEPKrBCV3bokPgleVc7BsrPxUKpcO/view?usp=sharing' // À remplacer par le lien Drive
    },
    {
      id: '3',
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/13Md9N3Qs-Oc1ekqvCo7E8juRo2e1QS54/view?usp=sharing' // À remplacer par le lien Drive
    },
    {
      id: '4',
      title: "Harmonie",
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1ZEvtTIafU9yJo0X_TDirxK4Zq_GciFrZ/view?usp=sharingf' // À remplacer par le lien Drive
    },
    {
      id: '5',
      title: "Énigme",
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1ueGrgrsSDIGEng8mV0CdbZfHl_puDzKh/view?usp=sharing' // À remplacer par le lien Drive
    },
    {
      id: '6',
      title: "Aria",
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1gXFqQ2xNZe6hj7NxjxZjUGiLBS76t0Il/view?usp=sharing' // À remplacer par le lien Drive
    },
    {
      id: '7',
      title: "Infinite Loop",
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1NqQfgLVgJXa2gPk33fw1XqOr2UAXaEe3/view?usp=sharing' // À remplacer par le lien Drive
    },
    {
      id: '8',
      title: "Spirale",
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1NbOrS9Yo_3K7piEGEdZrMxdrxBiao-Bt/view?usp=sharing' // À remplacer par le lien Drive
    },
    {
      id: '9',
      title: "Elan",
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1ZyJmliKndRvMjOM0YpynDvimldHq1Q5Z/view?usp=sharing' // À remplacer par le lien Drive
    },
    {
      id: '10',
      ...
      category: 'sculpture',
      style: 'contemporain',
      downloadUrl: 'https://drive.google.com/file/d/1E0mi0DrNkqAwVdt_tAsCqB9WUZuDsLXX/view?usp=sharing' // À remplacer par le lien Drive
    }
  ];
